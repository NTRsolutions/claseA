package com.apreciasoft.mobile.remisclasea.Services;

import com.apreciasoft.mobile.remisclasea.Entity.Company;
import com.apreciasoft.mobile.remisclasea.Entity.DriverCurrentAcountEntity;
import com.apreciasoft.mobile.remisclasea.Entity.DriverFull;
import com.apreciasoft.mobile.remisclasea.Entity.InfoTravelEntity;
import com.apreciasoft.mobile.remisclasea.Entity.RequetClient;
import com.apreciasoft.mobile.remisclasea.Entity.acountCompany;
import com.apreciasoft.mobile.remisclasea.Entity.costCenterCompany;
import com.apreciasoft.mobile.remisclasea.Entity.dataAddPlusDriverEntity;
import com.apreciasoft.mobile.remisclasea.Entity.driver;
import com.apreciasoft.mobile.remisclasea.Entity.fleetType;
import com.apreciasoft.mobile.remisclasea.Entity.modelEntity;
import com.apreciasoft.mobile.remisclasea.Entity.resp;
import com.apreciasoft.mobile.remisclasea.Entity.responseFilterVehicle;
